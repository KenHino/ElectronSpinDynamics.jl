...
function system_hamiltonian(
    sys::System, B::Float64, θ::Float64=0.0, ϕ::Float64=0.0
)::SMatrix{4,4,ComplexF64}
    return system_hamiltonian(; B=B, θ=θ, ϕ=ϕ, J=sys.J, D=sys.D, kS=sys.kS, kT=sys.kT)
end
...
function zeeman_hamiltonian(
    B::Float64, θ::Float64=0.0, ϕ::Float64=0.0
)::SMatrix{4,4,ComplexF64}
    """
...
function SchultenWolynes_hamiltonian(
    mol1::Molecule, mol2::Molecule, N::Integer
